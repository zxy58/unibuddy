...
export default function UnibuddyApp() {
    ...
    <div style={{ minHeight: '100dvh', background: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '28px 0' }}>
      <div style={{ position: 'relative' }}>
        ...
        <div style={{ background: '#1C1C1E', borderRadius: 56, padding: 10, boxShadow: '0 28px 80px rgba(0,0,0,0.22), 0 0 0 1px rgba(255,255,255,0.06)' }}>
          ...
          <div style={{ width: 393, height: 'min(852px, calc(100dvh - 96px))', background: '#ECEAE4', borderRadius: 48, overflow: 'hidden', display: 'flex', flexDirection: 'column', position: 'relative' }}>
            {/* Dynamic Island + status bar */}
            <div style={{ flexShrink: 0, background: '#ECEAE4', paddingTop: 12 }}>
  ...
  const headerBar = (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '4px 18px 10px', flexShrink: 0, background: '#ECEAE4', borderBottom: '1px solid rgba(0,0,0,0.07)' }}>
