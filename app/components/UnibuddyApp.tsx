...
export default function UnibuddyApp() {
    ...
    <div style={{ minHeight: '100dvh', background: '#F0F0F0', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '28px 0' }}>
      <div style={{ position: 'relative' }}>
        ...
        <div style={{ background: '#1C1C1E', borderRadius: 56, padding: 10, boxShadow: '0 28px 80px rgba(0,0,0,0.22), 0 0 0 1px rgba(255,255,255,0.06)' }}>
          ...
          <div style={{ width: 393, height: 'min(852px, calc(100dvh - 96px))', background: 'linear-gradient(to bottom, #F1F2F0 0%, #F1ECE4 55%, #F0F1EC 100%)', borderRadius: 48, overflow: 'hidden', display: 'flex', flexDirection: 'column', position: 'relative' }}>
            {/* Dynamic Island + status bar */}
            <div style={{ flexShrink: 0, background: '#F1F2F0', paddingTop: 12 }}>
  ...
  const headerBar = (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '4px 18px 10px', flexShrink: 0, background: '#F1F2F0', borderBottom: '1px solid rgba(0,0,0,0.07)' }}>
